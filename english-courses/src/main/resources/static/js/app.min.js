...
(APP = new (APP = function () {
...
})).UI = {scrollTop: 0}, $(window).on("load", function () {
    setTimeout(function () {
    ...
    $(".metismenu").metisMenu(), $('[data-toggle="tooltip"]').tooltip(), $('[data-toggle="popover"]').popover(), $(".scroller").each(function () {
        $(this).slimScroll({height: $(this).attr("data-height"), color: $(this).attr("data-color"), railOpacity: "0.9"})
        ...
        $(this).is(":checked") ? ($("body").addClass("fixed-layout"), $("#sidebar-collapse").slimScroll({
            height: "100%",
            railOpacity: "0.9"
        })) : ($("#sidebar-collapse").slimScroll({destroy: !0}).css({
            overflow: "visible",
            height: "auto"
